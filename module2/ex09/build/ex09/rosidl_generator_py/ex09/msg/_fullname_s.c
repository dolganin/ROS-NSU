...
bool ex09__msg__fullname__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ex09.msg._fullname.Fullname", full_classname_dest, 27) == 0);
  }
  ex09__msg__Fullname * ros_message = _ros_message;
  {  // last_name
...
PyObject * ex09__msg__fullname__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ex09.msg._fullname");
